...
pub use pallet::*;
//Why does it do this after it asked us to delete it?
//mod mock;
//mod tests;
...
pub mod pallet {
    ...
    // struct for auto male selection isn't needed anymore
    #[pallet::pallet]
    ...
    impl<T: Config> Pallet<T> {
        ...
        pub fn create_kitty(origin: OriginFor<T>) -> DispatchResult {
            ...
            //log still doesn't work ; logging to the console
        ...
        pub fn set_price(
            ...
            // Ensure the kitty exists and is called by the kitty owne
		...
		/// price of the kitty, marking it not for sale. // ACTION #5: transfer
        #[pallet::weight(100)]
        pub fn transfer(
            origin: OriginFor<T>, 
            to: T::AccountId, 
        ...
        kid2: T::Hash
            ...
            ensure!(Self::is_kitty_owner(&kid2, &sender)?, <Error<T>>::NotKittyOwner); // missing
    ...
    impl<T: Config> Pallet<T> {
        ...
        // This function was never mentioned on the tutorial, but it is needed to
        // It's just assumed from the code provided later.
        ...
        //Notice the use of [#transactional] which we imported at the very 
        //beginning of this tutorial. 
        //It allows us to write dispatchable functions that commit 
        //changes to the storage only if the annotated function return Ok. 
